...
\begin{figure}[H] 
	\centering 
	\includegraphics[width=0.6\linewidth]{perceptron.jpg}
...
Cada vez que se transfieren valores de una neurona a otra, se evalúa una discrepancia entre la predicción el valor verdadero y la predicción, con la que se ajustan los pesos mediante la función de pérdida:
\begin{gather}
